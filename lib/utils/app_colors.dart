...
class AppColors{
  ...
  static Color settingFavoriteColor =const Color(0xff5abd80);
  static Color settingLangColor =const Color(0xfffdd439);
  static Color settingLocationColor =const Color(0xffd9d9d9);
  static Color settingInterestsColor =const Color(0xfffd5c39);
  static Color settingContactColor =const Color(0xff399ffd);
